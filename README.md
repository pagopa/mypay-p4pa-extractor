...
| payment_notification                         | `/db/mypay/payment-notification/payment-notification.sql` | <li>ipaCode: organization IPA code (required)<br><li>iud: payment IUD (nullable)<br><li>iuv: payment IUV (nullable)<br><li>createdFrom: inclusive creation timestamp applied to `mygov_flusso_import.dt_creazione` (nullable)<br><li>createdTo: inclusive creation timestamp applied to `mygov_flusso_import.dt_creazione` (nullable)<br><li>limit: page size (> 0)<br><li>offset: page start (>= 0, nullable) | Payment notification extractor from `mygov_flusso_import`, joined to `mygov_ente`, filtered by organization and optionally by IUD, IUV, and creation timestamps. Results are ordered by creation timestamp. |
