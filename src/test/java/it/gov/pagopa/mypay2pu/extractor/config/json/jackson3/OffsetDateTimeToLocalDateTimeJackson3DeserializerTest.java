package it.gov.pagopa.mypay2pu.extractor.config.json.jackson3;

import it.gov.pagopa.mypay2pu.extractor.config.json.OffsetDateTimeToLocalDateTimeDeserializer;
