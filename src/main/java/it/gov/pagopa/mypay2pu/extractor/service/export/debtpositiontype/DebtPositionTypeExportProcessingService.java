...
@Service
public class DebtPositionTypeExportProcessingService extends BaseCsvExportProcessingService<DebtPositionType, PuDebtPositionTypeDTO> {
  ...
  public DebtPositionTypeExportProcessingService(DebtPositionTypeDao debtPositionTypeDao,
                                                 ...
                                                 CsvPartitionWriterService<PuDebtPositionTypeDTO> csvPartitionWriterService,
  ...
  protected List<DebtPositionType> retrieveData(ExtractionRequest request, int pageSize, int offset) {
    ...
    return debtPositionTypeDao.findByFilters(
      ValueLogicalKeyValidator.parseLogicalKey(
